...
public class ViewAllEmpFrame extends javax.swing.JFrame {
    ...
    public void showDataInTable(){
        try{
            ...
            if(EmpList.isEmpty()==true)
                JOptionPane.showMessageDialog(null, "Sorry! No Employees in Database","Error",JOptionPane.INFORMATION_MESSAGE);
            
            else{
                Object[] rows = new Object[4];
                DefaultTableModel model = (DefaultTableModel)jTabAllEmp.getModel();
                for(Emp e : EmpList){
                    rows[0] =  e.getEmpid();
                    rows[1] =  e.getEname();
                    rows[2] =  e.getJob();
    ...
    private void initComponents() {
        ...
        jTabAllEmp = new javax.swing.JTable();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)), "All Employee Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N

        jTabAllEmp.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jTabAllEmp.setForeground(new java.awt.Color(0, 102, 102));
        jTabAllEmp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTabAllEmp);
    ...
    private javax.swing.JTable jTabAllEmp;
